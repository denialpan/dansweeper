    ...
    while (!WindowShouldClose()) {
        ...
        if (state == MENU) {
            ...
            if (!useSeed) {
                ...
                GuiSliderBar((Rectangle){originX, originY + 80, 240, 20}, "Width", TextFormat("%d", gridWidth), &tempGridWidth, 5.0f, 1000.0f);
                GuiSliderBar((Rectangle){originX, originY + 110, 240, 20}, "Height", TextFormat("%d", gridHeight), &tempGridHeight, 5.0f, 1000.0f);
